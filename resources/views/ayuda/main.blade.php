			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div id="indice">
						...
						<ul>
							<li><a class="text-success" href="#actividad-informada">Actividad Informada</a></li>
							<li><a href="#carencias">Carencias del sistema</a></li>
							<li><a href="#estudios">Estudios</a></li>
							<li><a href="#metas">Metas</a></li>
							<li><a href="#revisitas">Revisitas</a></li>
						</ul>
					</div>
